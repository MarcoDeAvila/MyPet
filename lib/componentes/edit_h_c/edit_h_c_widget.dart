...
class EditHCWidget extends StatefulWidget {
  ...
  @override
  State<EditHCWidget> createState() => _EditHCWidgetState();
}
...
class _EditHCWidgetState extends State<EditHCWidget> {
  ...
  void initState() {
    ...
    _model.motivoTextController ??= TextEditingController(text: widget.motivo);
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                suffixIcon: _model
                                        .motivoTextController!.text.isNotEmpty
                                    ? InkWell(
                                        onTap: () async {
                                          _model.motivoTextController?.clear();
                                          setState(() {});
                                        },
                                        child: Icon(
                                          Icons.clear,
