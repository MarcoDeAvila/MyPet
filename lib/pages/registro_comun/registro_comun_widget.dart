...
import 'registro_comun_model.dart';
export 'registro_comun_model.dart';

class RegistroComunWidget extends StatefulWidget {
  const RegistroComunWidget({super.key});

  @override
  State<RegistroComunWidget> createState() => _RegistroComunWidgetState();
}

class _RegistroComunWidgetState extends State<RegistroComunWidget> {
  late RegistroComunModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegistroComunModel());
    ...
    _model.textFieldRazaTextController ??= TextEditingController();
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: _model.textFieldNombreTextController!
                                    .text.isNotEmpty
                                ? InkWell(
                                    onTap: () async {
                                      _model.textFieldNombreTextController
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (_) => EasyDebounce.debounce(
                            '_model.textFieldRazaTextController',
                            Duration(milliseconds: 2000),
                            () => setState(() {}),
                          ),
                          autofocus: false,
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: _model.textFieldRazaTextController!.text
                                    .isNotEmpty
                                ? InkWell(
                                    onTap: () async {
                                      _model.textFieldRazaTextController
                          ...
                          textAlign: TextAlign.start,
                          validator: _model.textFieldRazaTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('¡Espera!'),
                                      content:
                                          Text('Agrega un foto de tu mascota.'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                              ...
                              await MascotasRecord.collection
                                  ...
                                  .set(createMascotasRecordData(
                                    ...
                                    peso: int.tryParse(_model
                                        .textFieldPesoTextController.text),
                                    foto: _model.uploadedFileUrl2,
                                    raza:
                                        _model.textFieldRazaTextController.text,
