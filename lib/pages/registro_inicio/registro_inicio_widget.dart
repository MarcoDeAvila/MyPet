...
class RegistroInicioWidget extends StatefulWidget {
  const RegistroInicioWidget({super.key});

  @override
  State<RegistroInicioWidget> createState() => _RegistroInicioWidgetState();
}
                      ...
                      onPressed: () async {
                        ...
                        await MascotasRecord.collection
                            ...
                            .set(createMascotasRecordData(
                              ...
                              nombre: _model.textFieldNombreTextController.text,
                              edad: int.tryParse(
                                  _model.textFieldEdadTextController.text),
                              peso: int.tryParse(
                                  _model.textFieldPesoTextController.text),
                              foto: _model.uploadedFileUrl2,
                              raza: _model.textFieldRazaTextController.text,
